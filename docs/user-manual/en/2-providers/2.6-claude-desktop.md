...
${XDG_CONFIG_HOME:-~/.config}/Claude-3p/configLibrary/_meta.json
${XDG_CONFIG_HOME:-~/.config}/Claude-3p/configLibrary/00000000-0000-4000-8000-000000157210.json
```
...
|---------|---------------|
| Current platform is not supported | Upgrade to a version that supports writing 3P configuration on macOS / Windows / Linux |
